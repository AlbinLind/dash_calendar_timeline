...
- week_header_max_days (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'clickedItem', 'context_menu_options', 'default_time_end', 'default_time_start', 'deselected_legend_items', 'drag_snap', 'enable_external_drop', 'enable_week_headers', 'externalDrop', 'groups', 'isFixedChanged', 'item_height_ratio', 'items', 'line_height', 'locale', 'max_zoom', 'min_zoom', 'rightClickedEvent', 'rightClickedItem', 'selectedItemInput', 'skuChanged', 'sku_alternative_name', 'top_left_sidebar_content', 'use_resize_handle', 'visible_time_end', 'visible_time_start', 'week_header_max_days']
