...
- recurringItemChanged (string; optional)
...
- week_header_max_days (number; optional):
    ...
    ItemsItemProps = TypedDict(
        "ItemsItemProps",
            ...
            "style": NotRequired[typing.Dict[typing.Union[str, float, int], typing.Any]]
        }
    )
    ...
    Items = TypedDict(
        "Items",
            ...
            "canResize": NotRequired[typing.Union[Literal["left"], Literal["right"], Literal["both"]]],
    ...
    def __init__(
        ...
        selectedItemInput: typing.Optional[typing.Dict[typing.Union[str, float, int], typing.Any]] = None,
        ...
        recurringItemChanged: typing.Optional[str] = None,
        id: typing.Optional[typing.Union[str, dict]] = None,
        **kwargs
    ):
        self._prop_names = ['id', 'clickedItem', 'context_menu_options', 'default_time_end', 'default_time_start', 'deselected_legend_items', 'drag_snap', 'enable_external_drop', 'enable_week_headers', 'externalDrop', 'groups', 'isFixedChanged', 'item_height_ratio', 'items', 'line_height', 'locale', 'max_zoom', 'min_zoom', 'recurringItemChanged', 'rightClickedEvent', 'rightClickedItem', 'selectedItemInput', 'skuChanged', 'top_left_sidebar_content', 'use_resize_handle', 'visible_time_end', 'visible_time_start', 'week_header_max_days']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'clickedItem', 'context_menu_options', 'default_time_end', 'default_time_start', 'deselected_legend_items', 'drag_snap', 'enable_external_drop', 'enable_week_headers', 'externalDrop', 'groups', 'isFixedChanged', 'item_height_ratio', 'items', 'line_height', 'locale', 'max_zoom', 'min_zoom', 'recurringItemChanged', 'rightClickedEvent', 'rightClickedItem', 'selectedItemInput', 'skuChanged', 'top_left_sidebar_content', 'use_resize_handle', 'visible_time_end', 'visible_time_start', 'week_header_max_days']
